      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#605B51] text-lg">
            Sign in to your TrybeTickets account
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-[#605B51]">Remember me</span>
              </label>
              <Link href="/forgot-password" className="text-sm text-[#a855f7] hover:text-[#9333ea] font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-[#605B51]">Or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center mt-8 text-[#605B51]">
          ...
          <Link href="/signup" className="text-[#a855f7] hover:text-[#9333ea] font-semibold">
            Sign up for free
          </Link>
        </p>
      </div>
